/**
 * DemoHeatmapCtrl - controller
 */
function DemoHeatmapCtrl($rootScope, $scope, $location, AuthenticationService) {
...
angular
    .module('bdb')
    .controller('DemoHeatmapCtrl', DemoHeatmapCtrl);