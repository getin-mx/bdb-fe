/**
 * APDVisits2Ctrl - controller
 */
function APDVisits2Ctrl($scope, AuthenticationService, CommonsService, $rootScope, $http) {
    ...
    this.updateBrandPerformanceTable = function(id, baseUrl, fromDate, toDate, entityId) {
        $.getJSON(
            baseUrl 
            + '/dashoard/brandTableData2?entityId=' + entityId 
            + '&entityKind=1' 
            + '&fromStringDate=' + fromDate 
            + '&toStringDate=' + toDate 
            + '&onlyExternalIds=true',
...
angular
    .module('bdb')
    .controller('APDVisits2Ctrl', APDVisits2Ctrl);