 ...
 */
 function DemoVisits3Ctrl($rootScope, $scope, AuthenticationService, CommonsService, $rootScope, $http, ModalService) {
    ...
    $scope.stores = [];
    $scope.storeId = {};
    $scope.tableNResults = [{"id": 10, 'name': 10},
                            {"id": 20, 'name': 20},
                            {"id":50, 'name': 50},
                            {"id": 100, 'name':100}];
    $scope.tableNResultsId = $scope.tableNResults[0];

    //demo setup
    $scope.brandId = 'flormar_pa';
    $scope.storeId.identifier = "22855128-ff48-4953-95d4-2b049f529d03";

    var globals = AuthenticationService.getCredentials();
    var credentials = globals.currentUser;

    $scope.storeLabel = 'Cadena';
