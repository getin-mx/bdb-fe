 ...
 */
function APDVisitsLimitCtrl($scope, AuthenticationService, $rootScope, $http) {

    var vm = this;

    $scope.toDate = '2016-07-31';
    $('#toDate').val($scope.toDate);
    $scope.fromDate = '2016-07-01';
    $('#fromDate').val($scope.fromDate);
    $scope.storeId = '';
    $scope.maxDate = new Date(2016, 06, 31);
...
angular
    .module('bdb')
    .controller('APDVisitsLimitCtrl', APDVisitsLimitCtrl);