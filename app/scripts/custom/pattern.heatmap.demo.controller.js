 ...
 */
function PatternHeatmapDemoCtrl($rootScope, $scope, $location, AuthenticationService, CommonsService, $http) {
        ...
        $.getJSON(
            ...
            for (var i = 0; i < floormaps.data.length; i++) {
                ...
                tab += '<a  href="javascript:null"' + (i == 0 ? 'class="btActive"' : '')
                    ...
                    + id + '", "' + map.identifier + '")\'>' + 'Centro Comercial' + '</a>';
            }
...
angular
    .module('bdb')
    .controller('PatternHeatmapDemoCtrl', PatternHeatmapDemoCtrl);
