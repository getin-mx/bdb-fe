 ...
 */
 function APDVisitsCtrl($rootScope, $scope, AuthenticationService, CommonsService, $rootScope, $http, SweetAlert) {
    ...
    $scope.initAPDVisitsPhase2 = function(data) {
        ...
        // Please change this!
        if( $scope.brandId == 'aditivo_mx' || $scope.brandId == '98coastav_mx' || $scope.brandId == 'botanicus_mx' || $scope.brandId == 'tonymoly_mx' || $scope.brandId == 'areasmexico_mx' || $scope.brandId == 'ecobutik_mx')
